...
public class ProdutoController extends javax.swing.JFrame {
    ...
    private void jbLocalizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbLocalizarActionPerformed
        ...
        try {
            if (cliente.getTipo().equals(TipoUsuario.CLIENTE)) {
                ...
                String descricao = JOptionPane.showInputDialog("Procurar por: ");
                ProdutoService produtoService = new ProdutoService();
                produtos = produtoService.buscarProdutoPorDescricao(descricao);
                ...
                if (!produtos.isEmpty()) {
                    ...
                    JOptionPane.showMessageDialog(null, "Nenhum Produto encontrado com essa.");
                }
                ...
                int id = Integer.parseInt(JOptionPane.showInputDialog("Procurar por: "));
                if (produto != null) {
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        if (pedido.getItensPedido().size() > 0) {
            ...
            JOptionPane.showMessageDialog(null, "Você não pode finalizar a compra sem nenhum pedid no carrinho!!");
        }
